  ...
  return (
    <>
      <div className="aanpak-kaakklachten-container">
        ...
        <NavigationSimple rootClassName="navigation-simple-root-class-name1"></NavigationSimple>
        <div className="aanpak-kaakklachten-back">
          <Link href="/">
            <a className="aanpak-kaakklachten-link">
              <ButtonBack
                rootClassName="button-back-root-class-name1"
                className="aanpak-kaakklachten-component1"
              ></ButtonBack>
            </a>
          </Link>
        </div>
        <div className="aanpak-kaakklachten-content">
          <FeatureAanpak
            rootClassName="feature-aanpak-root-class-name1"
          ...
          ></FeatureAanpak>
          <AfspraakBanner rootClassName="afspraak-banner-root-class-name"></AfspraakBanner>
        </div>
          ...
          <div className="aanpak-kaakklachten-icon-group">
            ...
            >
              <svg
                ...
                className="aanpak-kaakklachten-icon"
              >
            ...
            >
              <svg
                ...
                className="aanpak-kaakklachten-icon2"
              >
      ...
      <style jsx>
        {`
          ...
          .aanpak-kaakklachten-link {
            display: contents;
          }
          .aanpak-kaakklachten-component1 {
