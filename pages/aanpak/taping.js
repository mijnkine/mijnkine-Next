  ...
  return (
    <>
      <div className="aanpak-taping-container">
        ...
        <NavigationSimple rootClassName="navigation-simple-root-class-name5"></NavigationSimple>
        <div className="aanpak-taping-back">
          <Link href="/">
            <a className="aanpak-taping-link">
              <ButtonBack
                rootClassName="button-back-root-class-name5"
                className="aanpak-taping-component1"
              ></ButtonBack>
            </a>
          </Link>
        </div>
        <div className="aanpak-taping-content">
          <FeatureAanpak
            rootClassName="feature-aanpak-root-class-name4"
          ...
          ></FeatureAanpak>
          <AfspraakBanner rootClassName="afspraak-banner-root-class-name4"></AfspraakBanner>
        </div>
