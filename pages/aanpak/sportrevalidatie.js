  ...
  return (
    <>
      <div className="aanpak-sportrevalidatie-container">
        <Head>
          <title>Sportrevalidatie - Mijn Kine Genk</title>
          <meta
            name="description"
          ...
          <meta
            property="og:title"
            content="Sportrevalidatie - Mijn Kine Genk"
          />
          <meta
        ...
        <NavigationSimple rootClassName="navigation-simpleroot-class-name6"></NavigationSimple>
        <div className="aanpak-sportrevalidatie-back">
          ...
          >
            <ButtonBack
              rootClassName="button-backroot-class-name6"
              className="aanpak-sportrevalidatie-component2"
            ></ButtonBack>
          </a>
        </div>
        <div className="aanpak-sportrevalidatie-content">
          <FeatureAanpak
            rootClassName="feature-aanpakroot-class-name5"
            ...
            aanpakFeatureImageSrc="/Aanpak/aanpak_sport-1400w.jpeg"
          ></FeatureAanpak>
          <AfspraakBanner rootClassName="afspraak-bannerroot-class-name5"></AfspraakBanner>
        </div>
          ...
          <div className="aanpak-sportrevalidatie-icon-group">
            ...
            >
              <svg
                ...
                className="aanpak-sportrevalidatie-icon1"
              >
            ...
            >
              <svg
                ...
                className="aanpak-sportrevalidatie-icon3"
              >
      ...
      <style jsx>
        {`
          ...
          .aanpak-sportrevalidatie-component2 {
