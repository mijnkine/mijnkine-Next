  ...
  return (
    <>
      <div className="aanpak-algemenetherapie-container">
        ...
        <NavigationSimple rootClassName="navigation-simple-root-class-name4"></NavigationSimple>
        <div className="aanpak-algemenetherapie-back">
          <Link href="/">
            <a className="aanpak-algemenetherapie-link">
              <ButtonBack
                rootClassName="button-back-root-class-name4"
                className="aanpak-algemenetherapie-component1"
              ></ButtonBack>
            </a>
          </Link>
        </div>
        <div className="aanpak-algemenetherapie-content">
          <FeatureAanpak
            rootClassName="feature-aanpak-root-class-name3"
          ...
          ></FeatureAanpak>
          <AfspraakBanner rootClassName="afspraak-banner-root-class-name3"></AfspraakBanner>
        </div>
          ...
          <div className="aanpak-algemenetherapie-icon-group">
            ...
            >
              <svg
                ...
                className="aanpak-algemenetherapie-icon"
              >
            ...
            >
              <svg
                ...
                className="aanpak-algemenetherapie-icon2"
              >
      ...
      <style jsx>
        {`
          ...
          .aanpak-algemenetherapie-link {
            display: contents;
          }
          .aanpak-algemenetherapie-component1 {
