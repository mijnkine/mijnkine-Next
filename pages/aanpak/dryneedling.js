  ...
  return (
    <>
      <div className="aanpak-dryneedling-container">
        ...
        <NavigationSimple rootClassName="navigation-simple-root-class-name2"></NavigationSimple>
        <div className="aanpak-dryneedling-back">
          <Link href="/">
            <a className="aanpak-dryneedling-link">
              <ButtonBack
                rootClassName="button-back-root-class-name"
                className="aanpak-dryneedling-component1"
              ></ButtonBack>
            </a>
          </Link>
        </div>
        <div className="aanpak-dryneedling-content">
          <FeatureAanpak
            rootClassName="feature-aanpak-root-class-name"
          ...
          ></FeatureAanpak>
          <AfspraakBanner rootClassName="afspraak-banner-root-class-name1"></AfspraakBanner>
        </div>
          ...
          <div className="aanpak-dryneedling-icon-group">
            ...
            >
              <svg
                ...
                className="aanpak-dryneedling-icon"
              >
            ...
            >
              <svg
                ...
                className="aanpak-dryneedling-icon2"
              >
      ...
      <style jsx>
        {`
          ...
          .aanpak-dryneedling-link {
            display: contents;
          }
          .aanpak-dryneedling-component1 {
