  ...
  return (
    <>
      <div className="aanpak-manueletherapie-container">
        ...
        <NavigationSimple rootClassName="navigation-simple-root-class-name3"></NavigationSimple>
        <div className="aanpak-manueletherapie-back">
          <Link href="/">
            <a className="aanpak-manueletherapie-link">
              <ButtonBack
                rootClassName="button-back-root-class-name3"
                className="aanpak-manueletherapie-component1"
              ></ButtonBack>
            </a>
          </Link>
        </div>
        <div className="aanpak-manueletherapie-content">
          <FeatureAanpak
            rootClassName="feature-aanpak-root-class-name2"
          ...
          ></FeatureAanpak>
          <AfspraakBanner rootClassName="afspraak-banner-root-class-name2"></AfspraakBanner>
        </div>
          ...
          <div className="aanpak-manueletherapie-icon-group">
            ...
            >
              <svg
                ...
                className="aanpak-manueletherapie-icon"
              >
            ...
            >
              <svg
                ...
                className="aanpak-manueletherapie-icon2"
              >
      ...
      <style jsx>
        {`
          ...
          .aanpak-manueletherapie-link {
            display: contents;
          }
          .aanpak-manueletherapie-component1 {
